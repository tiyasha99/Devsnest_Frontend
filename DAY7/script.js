...
{
  var v = cylinders[i].radius * cylinders[i].height * 2 * Math.PI;
  console.log(`Volume of a cylinder of height=${cylinders[i].height} and radius=${ cylinders[i].radius} is: ${v.toFixed(4)}`);
}
